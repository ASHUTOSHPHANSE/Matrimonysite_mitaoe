...
router.get('/profile', function (req, res, next) {
	...
	User.findOne({unique_id:req.session.userId},function(err,data){
		...
		if(!data){
			...
			//console.log("found");
			return res.render('profile.ejs', {"fname":data.firstn,"lname":data.lastn,"email":data.email,"mobile":data.mobile,"city":data.city,"dob":data.dob,"gender":data.gender,"religion":data.religion});
		}
	});
});
